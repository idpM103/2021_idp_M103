...
void loop() {
  ...
  if (button_state == HIGH) {
    ...
    // The restoring block, the last major block and the initial line following block will be executed again after this block is successfully executed.
    ...
    if(block_classified == HIGH){
      ...
      if(along_line == HIGH){
        ...
        if (left_inner_value < left_threshold && right_inner_value < right_threshold && right_most_value < right_threshold){
