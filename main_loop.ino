/*
This is Group M103 main code for the waste solving task.
The system is flag-based and can be devided into 4 stages/blocks. 
Flags restoring, Block delivering, Collection Sweep and Block detection.
Algorithmic and system level details will be shown in the diagram submission.
*/
...
void setup() {
  ...
  //attachInterrupt(hall_effect, hall_interrupt, FALLING);// hall_interrupt input cannot be function。
  ...
  if (button_state == HIGH) {
    ...
    if(block_classified == HIGH){
      ...
      // The second stage is the block delivering stage.
        ...
        // block_delivered <= 4 if possible to carry out 4 blocks
